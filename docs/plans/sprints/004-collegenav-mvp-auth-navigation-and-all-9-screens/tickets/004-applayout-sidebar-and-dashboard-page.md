...
- [ ] Sidebar renders on all protected pages with all 10 nav links + logout
- [ ] Active nav item has red left border and highlighted background
- [ ] Clicking a nav link navigates to the correct route
- [ ] Logout button calls `/api/auth/logout`, clears session, redirects to `/login`
- [ ] Dashboard shows "Welcome back, [name]" with correct grade and school from `StudentContext`
- [ ] Three progress cards render at 0%
