...
- [ ] Visiting `/login` shows the login form without auth
- [ ] Visiting `/signup` shows the signup form without auth
...
- [ ] Signup form submits to `/api/auth/signup` and redirects to `/dashboard` on success
- [ ] Signup page shows the "separate email" tip box
- [ ] Login/Signup pages have links to each other
- [ ] `StudentContext` is available throughout the app
- [ ] Existing admin routes (`/admin`, `/admin/*`) are unaffected
